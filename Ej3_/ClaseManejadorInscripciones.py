...
class ManejadorInscripciones:
    ...
    def generarArchivo(self, newfile):
        ...
        for i in range(self.__cantidad):
            line = [self.__inscripciones[i].getPersona().getDNI(),self.__inscripciones[i].getTaller().getIdTaller(),self.__inscripciones[i].getFecha(),self.__inscripciones[i].getPago()]
